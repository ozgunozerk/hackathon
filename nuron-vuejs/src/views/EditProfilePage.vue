                    ...
                    <div class="profile-left col-lg-4">
                      <div class="profile-image mb--30">
                        ...
                        <img
                          id="profilePicture"
                          :src="
                            require(`@/assets/images/profile/profile-01.jpg`)
                          "
                          alt="Profile-NFT"
...
Hello, I am Alamin, A Front-end Developer...</textarea
                    >
                  </div>
                  ...
                  <div class="button-area save-btn-edit">
                    ...
                    <a
                      ...
                      @click="alert('Successfully Saved Your Profile?')"
                      >Save</a
                    >
                  </div>
                </div>
              ...
              >
                <div class="nuron-information">
                  ...
                  <a
                    ...
                    @click="alert('Successfully Changed Password?')"
                    >Save</a
                  >
                </div>
              </div>
