              ...
              <div class="banner-content-wrapper">
                ...
                <div class="wallet-image-wrapper">
                  <a href="#" class="avatar" data-tooltip="BITLY">
                    <img
                      :src="require(`@/assets/images/icons/wallet/4.png`)"
                      alt="wallet_image"
                    />
                  </a>
                  <a href="#" class="avatar" data-tooltip="D-Coin">
                    <img
                      :src="require(`@/assets/images/icons/wallet/7.png`)"
                      alt="wallet_image"
                    />
                  </a>
                  <a href="#" class="avatar" data-tooltip="Trans Card">
                    <img
                      :src="require(`@/assets/images/icons/wallet/8.png`)"
                      alt="wallet_image"
                    />
                  </a>
                  <a href="#" class="avatar" data-tooltip="Meta Mask">
                    <img
                      :src="require(`@/assets/images/icons/wallet/1.png`)"
                      alt="wallet_image"
                    />
                  </a>
                  <a href="#" class="avatar" data-tooltip="E-Currency">
                    <img
                      :src="require(`@/assets/images/icons/wallet/3.png`)"
                      alt="wallet_image"
                    />
                  </a>
                  <a href="#" class="avatar" data-tooltip="BitCoin">
                    <img
                      :src="require(`@/assets/images/icons/wallet/2.png`)"
                      alt="wallet_image"
                    />
                  </a>
                  <a href="#" class="avatar" data-tooltip="Attar Process">
                    <img
                      :src="require(`@/assets/images/icons/wallet/6.png`)"
                      alt="wallet_image"
                    />
                  </a>
                  <a href="#" class="avatar" data-tooltip="Mark JOrdan">
                    <img
                      :src="require(`@/assets/images/icons/wallet/5.png`)"
                      alt="wallet_image"
                    />
                  </a>
                </div>
