    ...
    <div class="rn-slider-area">
      ...
      >
        <slide v-for="(carouselItem, index) in carouselItems" :key="index">
          <div
            :class="`${carouselItem.image} bg_image d-flex align-items-center padding-controler-slide-product justify-content-center slide slide-style-2 fullscreen_image-banner position-relative`"
                ...
                <div class="col-lg-7">
                  <div class="inner text-start">
                    <div class="top-bid-price d-flex">
                      <span class="latest-bid mr--15">{{
                        carouselItem.latestBid
                      }}</span>
                      <div class="last-bid color-primary">
                        {{ carouselItem.lastBid }}
                      </div>
                    </div>
                  ...
                  <div class="place-bet-area into-banner mt_md--30 mt_sm--30">
                    <div class="rn-bet-create">
                          ...
                          <div class="top-seller-wrapper">
                            ...
                            <div class="top-seller-content">
                              <span class="heighest-bid">
                                Heighest bid
                                <router-link :to="`/author/7`"
                                  >Atif aslam</router-link
                                >
                              </span>
                              <span class="count-number"> 0.115SSC </span>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="bid-list text-start left-bid">
                        ...
                        <countdown
                          class="mt--15"
                          :date="carouselItem.countdown.date"
                        />
                      </div>
                    </div>
                    <button
          ...
          <div class="col-12">
            <div class="about-wrapper text-center">
              ...
              <p class="discription">
                ...
                non. Proin gravida nibh vel velit auctor aliquet. Aenean
                sollicitudin, lorem quis bibendum auctor, nisi elit consequat
